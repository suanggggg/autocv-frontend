        ...
        <template #default="scope_29cj778vm7i">
          <ElMain>
            <div class="button-group">
              <ElButton type="primary" @click="createTask">创建</ElButton>
...
export default defineComponent({
  ...
  setup() {
    ...
    const toggleTask = async () => {
      ...
      create4.append('user_id', userId);
      create4.append('task_id', taskId);
      if (radio.value == 'true') {
    ...
    const createTask = async () => {
      ...
      create1.append('original_sample_id', original_sample_id)
      ...
      let create5 = new FormData();
      create5.append('user_id', userId);
      create5.append('task_id', taskId);
      for (const model of selectmodel.value) {
        create5.append('selectedModel', model);
      }
      //await proxy.$api.train(create5);
    }
    ...
    const selectmodelOptions = ref(['resnet18', 'resnet50']);
